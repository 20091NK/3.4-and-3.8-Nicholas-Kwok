...
const slideDescB = ["Science", "Science, Social Studies and Digital Technology", "English, Digital Technology and Commerce (Currently Unavailable)", "Languages", "Drama", "Maori", "Art and DVCO", "Deans", "Music", "Maths", "Drama", "Maths and English", "Physical Technology", "Supported Learning Center", "Gym", "Student Office", "Assembly Hall", "Library", "Canteen", "Resource Center", "Pavilion", "Admin & Visitors"];
...
function showSlidesB(n) {
  ...
  let c = slideDescB;
  let d = document.getElementsByClassName("scene-thumbnail");
  ...
  d[slideIndexB - 1].style.display = "block";
